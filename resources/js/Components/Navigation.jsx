...
import { Dropdown as UIDropdown } from '@/Components/ui/dropdown';
                            ...
                            <div className="ml-3 relative">
                                <Menu>
                                    <UIDropdown>
                                        ...
                                        <UIDropdown.Content>
                                            <UIDropdown.Link href={route('profile.edit')}>Profile</UIDropdown.Link>
                                            {auth.user.is_admin && (
                                                <UIDropdown.Link href={route('admin.users')}>User Management</UIDropdown.Link>
                                            )}
                                            <UIDropdown.Link href={route('logout')} method="post" as="button">
                                                Log Out
                                            </UIDropdown.Link>
                                        </UIDropdown.Content>
                                    </UIDropdown>
